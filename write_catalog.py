...
<head>
    ...
    <title>Katalog PDF - Ika / Ira Sound System Production</title>
    <meta name="description" content="Katalog Resmi Sewa Sound System, Panggung Rigging, Lighting Stage, Videotron LED P3.1, Tenda Sarnafil & Alat Musik - Ika / Ira Sound System Production Bogor">
...
<body>
    ...
    <header class="top-toolbar">
        <div class="toolbar-brand">
            ...
            <div>
                <div class="brand-title">Ika / Ira Sound System Production</div>
        ...
        <div class="toolbar-actions">
            ...
            <a href="https://wa.me/6289638626771?text=Halo%20Ika%20Ira%20Sound%20System%20Production,%20saya%20ingin%20konsultasi%20sewa%20peralatan" target="_blank" class="btn btn-wa">
    ...
    <div class="pdf-catalog-wrapper">
        ...
        <div class="printable-page">
            ...
            <div class="page-inner-container" style="text-align: center;">
                <div style="margin-top: 15px;">
                    <div style="font-family: 'Montserrat', sans-serif; font-size: 34px; font-weight: 900; letter-spacing: 2px; color: #fff;">IKA / IRA</div>
            ...
            <div class="page-inner-container">
                <div>
                    <div class="pdf-brand-hdr">
                        <h2>Ika / Ira Sound System Production</h2>
                ...
                <div>
                    ...
                    <div style="display: grid; grid-template-columns: 1.1fr 0.9fr; gap: 16px; background: var(--bg-card); border: 1px solid var(--border-gold); border-radius: 12px; padding: 20px;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 10px;">
                            ...
                            <div class="pdf-img-box" style="height: 140px; margin-bottom: 0;">
                                <img src="https://images.unsplash.com/photo-1462965326201-d02e4f455804?auto=format&fit=crop&w=600&q=80" alt="Keyboard Synthesizer">
                            </div>
            ...
            <div class="page-inner-container">
                <div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        ...
                        <div class="pdf-card">
                            <div class="pdf-img-box" style="height: 250px;">
                                <img src="https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?auto=format&fit=crop&w=800&q=80" alt="Paket 3000W">
                            </div>
        ...
        <!-- 14: COVER PENUTUP & KONTAK -->
        <div class="printable-page">
            <div class="page-stage-bg" style="background-image: url('https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=1200&q=80'); opacity: 0.35; filter: none;"></div>
            <div class="page-inner-container" style="text-align: center; justify-content: center;">
                <div style="margin-bottom: 30px;">
                    <div style="font-family: 'Montserrat', sans-serif; font-size: 38px; font-weight: 900; letter-spacing: 2px;">IKA / IRA</div>
                ...
                <div style="text-align: center;">
                    ...
                    <a href="https://wa.me/6289638626771?text=Halo%20Ika%20Ira%20Sound%20System%20Production,%20saya%20ingin%20konsultasi%20sewa%20peralatan" target="_blank" class="btn btn-wa" style="margin-top: 20px; font-size: 15px; padding: 12px 28px;">
...
print("Catalog successfully written to index.html and index.html.html")
